...
def main() -> int:
    ...
    parser.add_argument("--retries", type=int, default=1, help="Attempts per check before failing.")
    parser.add_argument("--retry-delay", type=float, default=0.0, help="Delay between retries in seconds.")
    parser.add_argument(
        "--internal-token",
