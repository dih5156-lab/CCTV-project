...
- [../architecture/PROJECT_STRUCTURE.md](../architecture/PROJECT_STRUCTURE.md): 전체 구조와 데이터 흐름
- [../api/EVENT_SCHEMA_STANDARD.md](../api/EVENT_SCHEMA_STANDARD.md): AI/센서/디바이스 이벤트 표준 스키마
- [../api/PUBLIC_API_GUIDE.md](../api/PUBLIC_API_GUIDE.md): Public API 사용 가이드
- [../api/PUBLIC_API_EXAMPLES.md](../api/PUBLIC_API_EXAMPLES.md): Public API 복붙용 샘플
