...
- [../architecture/PROJECT_STRUCTURE.md](../architecture/PROJECT_STRUCTURE.md): 전체 프로젝트 구조와 데이터 흐름
...
- [../architecture/ACTION_LAYER_SPEAKER_BRIDGE.md](../architecture/ACTION_LAYER_SPEAKER_BRIDGE.md): Action Layer와 알람 장치 연동
- [../architecture/KUIPER_RULE_ENGINE.md](../architecture/KUIPER_RULE_ENGINE.md): eKuiper 룰 엔진 구성
