...
Original agent documents live under `tooling/agents/`. They are development-tool
reference material and are not part of the CCTV runtime.

Repository classification:

- Required tooling: `.codex/skills/`, `.github/agents/`
- Reference material: `tooling/agents/`
...
- `.github/agents/*.agent.md` controls the UI-facing agent definitions tracked with the repo.
